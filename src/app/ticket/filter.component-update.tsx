...
export const Filter = () => {
  ...
  /* Start Options sorting filtering*/
  // const [sortFieldValue, setSortFieldValue] = useState<AutocompleteOptions[]>(
  //   []
  // );
  ...
  useEffect(() => {
    const params: FilterRequestValue = {
      ...
      RequestedColumns: initialValues?.RequestedColumns?.length
  ...
  return (
    <Formik
      ...
      onSubmit={async (values: FilterFormValue) => {
        const params: FilterRequestValue = {
        ...
        params.SortFields?.forEach((item, index) => {
          flattened[`SortFields[${index}].SortBy`] = item.SortBy;
          flattened[`SortFields[${index}].SortOrder`] = item.SortOrder;
        });

        const updatedParams = {
          ...params,
          ...flattened,
          SortFields: undefined, // remove original SortFields array
        };

        setFilters(trimObjectStrings(updatedParams));
                    ...
                    autoCompleteProps={{
                      ...
                      onChange: (row) => {
                        ...
                        setSelectedDepartmentId(
                          (row as AutocompleteOptions)?.value
                        );
                        setSelectedTeamId("");
                        setServiceTypeId("");
                ...
                <div className="col-12 md:col-6 lg:col-3">
                  <FormikAutoComplete
                    ...
                    autoCompleteProps={{
                      ...
                      // options: ticketOptionsOrderBy.options,
                      options: newTicketOptionsOrderBy.options.map(
                        (val, index) => {
                          return {
